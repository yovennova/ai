    ...
    <div className="flex flex-col h-[calc(100vh-120px)] bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-3 bg-white/50 backdrop-blur-sm sticky top-0 z-10">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Ask me anything about your studies</p>
        </div>
      </div>
        ...
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center text-center max-w-sm mx-auto space-y-4">
            ...
            <p className="text-sm text-slate-500">
              I can help you explain concepts, solve math problems, or give you study tips.
            </p>
            <div className="flex flex-wrap gap-2 justify-center pt-4">
              {["Explain Quantum Physics", "How to study for exams?", "Solve x^2 + 5x + 6 = 0"].map((suggestion) => (
                <button
                  key={suggestion}
      ...
      <form onSubmit={handleSend} className="p-4 bg-slate-50 border-t border-slate-100">
        <div className="relative max-w-4xl mx-auto">
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 pr-14 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm"
          />
          <button
            type="submit"
